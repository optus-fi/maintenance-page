...
const LightTop = () => {
  return (
    <div className='ligtTOPwrapper  absolute flex justify-center z-50 '>
      {/* <div className='ligtTOP flex justify-center items-center z-50 text-center absolute'>
          <span className='text-center'></span>
      </div> */}
      <svg width="736" height="613" viewBox="0 0 736 613" fill="none" xmlns="http://www.w3.org/2000/svg">
<g opacity="0.7">
...
<path d="M284.008 61.1499C284.008 -111.129 302.815 -606.072 316.744 -606.072C330.672 -606.072 376.594 -713.222 376.594 -540.944C376.594 -368.665 412.782 113.181 398.853 113.181C384.924 113.181 284.008 233.428 284.008 61.1499Z" fill="#DCC9FF"/>
</g>
</g>
<defs>
